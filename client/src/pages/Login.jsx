...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="glass-card p-10 relative overflow-hidden rounded-3xl shadow-2xl">
          {/* Decorative Corner */}
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-[var(--text)] opacity-60 text-sm mt-2 uppercase tracking-widest font-semibold">{t('settings.taglineText')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-primary text-white font-bold py-3.5 rounded-xl transition-all shadow-lg hover:shadow-xl tracking-wide mt-4"
            >
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-[var(--text)] opacity-60 font-medium">{t('auth.newToMoiKanakku')}</span>
            </div>
          </div>
